            ...
            return (
              <Link key={book.id} href={`/books/${book.id}`} className="block">
                <motion.div
                  ...
                  className="group cursor-pointer flex flex-col bg-card hover:bg-white rounded-xl p-5 border border-border/40 hover:border-accent/30 shadow-sm hover:shadow-xl transition-all duration-300 h-full"
                >
        ...
        <div className="flex justify-center pt-8 border-t border-border/40">
          <Link href="/books/all">
            <motion.div 
              ...
              className="inline-flex items-center gap-3 text-foreground font-serif text-lg hover:text-accent font-bold transition-colors group px-6 py-3 bg-secondary/40 hover:bg-secondary rounded-full border border-border/30 cursor-pointer"
            >
