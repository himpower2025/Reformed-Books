...
function OpenBook({
  ...
  return (
    <div className="book-scene w-full flex justify-center" style={{ height: BOOK_H + 40 }}>
      {/* Fully fluid scaling for multiple screens */}
      <div 
        className="relative origin-center transition-transform duration-300 scale-[0.45] min-[400px]:scale-[0.55] sm:scale-[0.72] md:scale-[0.88] lg:scale-100" 
